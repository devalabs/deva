  ...
  const pages = [
    ...
    // Page 6: Baymax Learning Centre Detail
    {
      ...
      content: {
        ...
        rightImage:
          "https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=600&h=800&fit=crop",
    ...
    // Page 11: Guggenheim Helsinki Detail
    {
      ...
      content: {
        ...
        rightImage:
          "https://images.unsplash.com/photo-1582407947304-fd86f028f716?w=600&h=800&fit=crop",
    ...
    <main className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="min-h-screen flex items-center justify-center p-8 transition-all duration-700">
        ...
        {currentPageData.type === "project-detail" && (
          <div className="max-w-7xl w-full h-[85vh] grid grid-cols-2 gap-8 bg-white text-black p-8">
      ...
      <button
        ...
        className="fixed left-8 top-1/2 -translate-y-1/2 text-2xl text-zinc-600 hover:text-white transition-colors disabled:opacity-20 disabled:cursor-not-allowed"
      >
        ←
      </button>
      <button
        ...
        className="fixed right-8 top-1/2 -translate-y-1/2 text-2xl text-zinc-600 hover:text-white transition-colors disabled:opacity-20 disabled:cursor-not-allowed"
      >
        →
      </button>
