...
export default function PortfolioPage() {
  ...
  const pages = [
    ...
    // Page 2: TUBE³ Hero
    {
      type: "project-hero",
      content: {
        title: "PROJECT COLECTIONS",
        subtitle:
          "In this project-based unit, I developed a complete fashion collection from concept to final presentation, deepening my understanding of identity, product meaning, functionality, sustainability, and the creative process. Throughout the course, I explored and defined my own designer identity, building a collection that reflected my personal aesthetic, values, and creative universe. I worked with professional design methodologies, moving through every stage of collection development: conceptual research, visual studies, color and material selection, silhouette exploration, technical design, and prototype creation. I learned to translate two-dimensional technical drawings into three-dimensional garments, integrating pattern-making and manufacturing knowledge into my creative decisions. The project encouraged critical, ethical, and environmental awareness, pushing me to consider the full lifecycle of a garment—from concept and production to wearability and broader cultural meaning. I also strengthened skills in organization, communication, time management, and teamwork, mirroring the workflow of a professional fashion studio. By the end of the unit, I was able to design, develop, and communicate a coherent collection suitable for fashion studios, design offices, or companies within the textile and fashion industry. ",
        details: [
          " FASHION DESIGN PROJECT I / II",
          "TEACHER'S: CARLA PONTES, TÂNIA NICOLE",
          "DURATION: 300H",
          "YEAR: 2020/2024",
        ],
        image:
    ...
    // Page 5: Baymax Learning Centre Hero
    {
      type: "project-hero",
      content: {
        title: "PATTERN MODELING AND PROTOTYPING",
        subtitle:
          "In this unit, I developed my ability to transform design concepts into functional garment prototypes. I learned to interpret technical sketches, analyze technical files, and convert ideas from 2D patterns into 3D forms. Throughout the process, I strengthened my creativity, autonomy, and critical decision-making by approaching each project as a designer or technician responding to a client brief. Working hands-on in the sewing workshop, I became familiar with the equipment and techniques required for prototype construction. I selected appropriate raw materials, prepared and cut fabrics, assembled garment components, and refined finishing details. This experience allowed me to evaluate quality at every stage of production and bring complete, well-executed prototypes to life.",
        details: [
    ...
    // Page 7: Urban Spiral Hero
    {
      ...
      content: {
        title: "PHOTOGRAPHY",
        subtitle:
          "In fashion photography, I explore the relationship between clothing, identity, and visual storytelling. I develop concepts, direct models, choose locations, and work with lighting to create strong, expressive images that communicate mood, narrative, and brand identit. My approach combines creative direction with technical skills in composition, photo editing, and visual communication.",
        details: [
          "FASHION PHOTOGRAPHY",
          "TEACHER : RUI FERREIRA",
          "DURATION : 50H",
          "YEAR : 2020/2021",
        ],
        image:
    ...
    // Page 10: Guggenheim Helsinki Hero
    {
      ...
      content: {
        ...
        subtitle:
          "In this unit, I developed essential skills in 2D and 3D CAD modeling applied to fashion design. Using software such as CLO3D and contemporary vector-based tools, I learned to create technical drawings, garment patterns, and three-dimensional virtual prototypes that support both the creative and production processes in fashion.Throughout the course, I explored the use of digital modeling to visualize silhouettes, test constructions, and simulate materials, allowing for faster decision-making and more efficient development of garments. I practiced transforming 2D technical files into 3D models, preparing files for digital cutting, and manipulating graphics for use in prints, trims, and pattern development.This experience strengthened my ability to analyze and interpret digital models, understand the role of CAD systems in industrial and creative workflows, and apply these tools within the real context of building a fashion collection. By the end of the unit, I was able to create and present a full 3D garment project, integrating all the technical and creative competencies acquired.",
        details: [
          "CAD LABORATORY",
          "TEACHER : SÉRGIO OLIVEIRA",
          "DURATION : 60H",
          "YEAR : 2021/2022",
        ],
        image:
    ...
    // Page 12: Tower of Natural Selection Hero
    {
      type: "project-hero",
      content: {
        title: "DIGITAL ILLUSTRATION, GRAPHIC AND AUDIOVISUAL COMMUNICATION",
        subtitle:
        ...
        details: [
          "DIGITAL ILLUSTRATION, GRAPHIC AND AUDIOVISUAL COMMUNICATION",
          "TEACHER'S : LURDES MOREIRA, FÀBIO RODRIGUES",
          "DURATION : 150H",
          "YEAR : 2020 /2024",
        ],
        image:
    ...
    // Page 13: Intership Selection Hero
    {
      ...
      content: {
        ...
        details: [
          "PLAN: CREATION EXPERIMENTATION IN MODELING, MAKING SAMPLES, LOOKBOOK, STYLING, COLLECTION SHOOTING AND COMMUNICATION PRODCUTION OF CONTENT FOR SOCIAL MEDIA.",
          "YEAR: 2024",
          "LOCATION: PORTO",
          "TAGS: UPCYLING, PRODUCTION, DESIGN, STYLE, SHOOTING, COMMUNICATION.",
        ],
        image:
          "https://images.unsplash.com/photo-1449824913936-59a10b8d2000?w=1200&h=800&fit=crop",
      },
    },
